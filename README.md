...
- **Automated builds and CI** with [Circle CI](https://circleci.com/bb/tapendium/serverless-starter) - _get early feedback for every change_.
...
- **Code analysis** with [TSLint](https://palantir.github.io/tslint/) and [Codebeat](https://codebeat.co/a/ashley/projects/bitbucket-org-tapendium-serverless-starter-master) - _avoid dumb coding mistakes._
